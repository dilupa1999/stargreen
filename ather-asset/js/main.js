...
//========== NICE SELECT ============= //
// Check if niceSelect plugin is loaded before using it
...
$('.project12-slider-area').owlCarousel({
  ...
  responsive:{
    ...
    $('.service-slider').owlCarousel({
        loop: true,
        margin: 30, // Sets the gap between slides
        nav: true,
        dots: true,
        center: false, // Centering can remain false for consistent gaps
        navText: ["<i class='fa-solid fa-angle-left'></i>", "<i class='fa-solid fa-angle-right'></i>"],
        autoplay: false,
        smartSpeed: 2000,
        responsiveClass: true,
        responsive: {
            ...
            1000: {
                items: 3, // Visible slides at large screens
            }
        }
    });
